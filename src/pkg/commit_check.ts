 ...
 */
export const getCommitStatusUpdateURL = (
  ownerName: string,
...
export const setPendingCommitStatus = async (commitStatusURL: string) => {
  const pendingBody: CommitStatusUpdate = {
    state: "pending",
    context: "ci-joe",
  };
...
export const setSuccessCommitStatus = async (commitStatusURL: string) => {
  const successBody: CommitStatusUpdate = {
    state: "success",
    context: "ci-joe",
  };
...
export const setFailureCommitStatus = async (commitStatusURL: string) => {
  const failureBody: CommitStatusUpdate = {
    state: "failure",
    context: "ci-joe",
  };
